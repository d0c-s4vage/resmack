...
namespace states {
  ...
  void MmapState::InsertHooks(TargetHooks* hooks) {
    ...
    hooks
      ->AddGlobalIpcInit([this](ipc::QueuedSharedMem* mem) {
        this->ipc_mem = mem;
        mem->AddReceiveHandler(
          ipc::QueuedUpdateTypes::STATE,
          [this](size_t, void* data, ipc::LockedSharedMem*) {
      ...
      ->AddPreTest([&start](ipc::QueuedSharedMem*, ipc::QueuedSharedMem* global_mem) {
        local_counter++;
